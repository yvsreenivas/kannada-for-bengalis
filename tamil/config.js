// Direction: Kannada speakers learning Tamil
window.CONFIG = {
  targetLang: "ta",
  uiLang: "kn",
  ttsLang: "ta-IN",
  ttsPrefix: "ta",
  storageKey: "tfk-progress",
  digits: "೦೧೨೩೪೫೬೭೮೯",
  strings: {
    noTts: "ಈ ಬ್ರೌಸರ್‌ನಲ್ಲಿ ಧ್ವನಿ ಬೆಂಬಲವಿಲ್ಲ. Chrome ಬಳಸಿ ನೋಡಿ.",
    noVoice: "ಈ ಸಾಧನದಲ್ಲಿ ತಮಿಳು ಧ್ವನಿ ಇಲ್ಲ — ಮೊಬೈಲ್ Chrome ನಲ್ಲಿ ಚೆನ್ನಾಗಿ ಕೇಳಿಸುತ್ತದೆ.",
    listen: "ಕೇಳಿ",
    vowelsTitle: "ಸ್ವರಗಳು (உயிரெழுத்து)",
    yogavahaTitle: "ಆಯ್ತಂ (ஆய்தம்)",
    consonantsTitle: "ವ್ಯಂಜನಗಳು (மெய்யெழுத்து)",
